...
import { printToHTML, printHighlightedHTML } from '../js/pci/util/printToHTML.mjs';
...
let dummy = function materialTest() {
    ...
    assert(
        LowDash.isEqual(shortDeserializedCFRP, deserializedCFRP),
    ...
    assert(LowDash.isEqual(cfrp, deserializedCFRP), "Deserialized cfrp is equal to the original.");
